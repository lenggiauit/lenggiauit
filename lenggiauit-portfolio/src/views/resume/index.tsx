...
import { Divider, SmallDivider } from '../../components/divider';
  ...
  return (
    <>
      <Layout isPublic={true}>
        <section id="resume" className="bg-white pb-5" >
          {/* <!-- About --> */}
          <div className="about">
            <SectionTitle>
              <ENTranslation>
                  ...
                  <div className="col-md-12">
                    <div className="exp-holder margTop">
                      <div className="exp">
                        ...
                        <p className="mt-3">
                          I currently work at Titan company, where I have been working for 2 years. I work on a smart audit project for a client which is a venture of the Deloitte company.
                        </p>
                      ...
                      <div className="exp">
                        ...
                        <p className="mt-3">I worked for Aperia company which has a headquarters in the United States. I worked there for 8 years on many projects in the Card industry, Financial Services, Merchant acquiring, Risk management, and SaaS (Software as a service).</p>
                        <ol className="list-inside">
                ...
                <div className="row ">
                  <div className="col-md-12">
                    <div className="exp-holder margTop">
                      <div className="exp">
                        <div className="hgroup">
                          <h3>Diploma of National Institute of Information Technology</h3>
                          <h6><i className="bi bi-calendar"></i>May 2009 - May 2011</h6>
                          <h6><i className="bi-geo-alt"></i>NIIT Viet Nam</h6>
                        </div>
                        Software Engineering - Microsoft Technologies - Outstanding grade
                      </div>
                    </div>
                  </div>
                </div>
